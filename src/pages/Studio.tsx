...
import { 
  ...
  Plus, MessageSquare, Users, Settings 
} from "lucide-react";
        ...
        <div className="flex-1 flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/4 p-4 bg-cyber-darker border-r border-cyber-purple/20">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button variant="ghost" size="icon" className="text-white hover:text-cyber-purple hover:bg-cyber-purple/10">
              ...
              <TabsContent value="notes">
                ...
                <div className="mt-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Button variant="outline" size="sm" className="border-dashed border-cyber-purple/30 text-xs">
                      + Invite
                    </Button>
                  </div>
                </div>
